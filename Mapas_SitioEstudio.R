...
class(elevacion)
elevacion$DEM_muni
projection(elevacion)


#Hacer data frame
elev_cdf <- as(elevacion, "SpatialPixelsDataFrame")
summary(elev_cdf)
...
path <- "Colibrí_cola_de_oro.jpeg"
